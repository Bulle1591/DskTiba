...
var itemTable;
    ...
    $(document).ready(function () {
        ...
        columns: [
            ...
            {name: "name", data: "name"},
            {name: "item_type_display", data: "item_type_display"},
            {name: "description", data: "description"},
            {name: "quantity_on_hand", data: "quantity_on_hand"},
            {name: "unit_of_measure", data: "unit_of_measure"},
            {name: "dosage_form_display", data: "dosage_form_display"},
            {name: "strength", data: "strength"},
            {name: "storage_conditions", data: "storage_conditions"},
    ...
    $('#itemTable thead th:eq(0)').html('<input type="checkbox" id="select-all">');
    ...
    var selectedIds = $('#itemTable input[type="checkbox"]:checked').map(function() {
    ...
    if (selectedIds.length > 0) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                $('#itemTable input[type="checkbox"]').prop('checked', false);
                // Show or hide buttons based on whether any checkboxes are selected
                toggleButtons();
            }
        });
...
function toggleButtons() {
    if ($('#itemTable input[type="checkbox"]:checked').length > 0) {
