...
var itemCategoryTable;
    ...
    $(document).ready(function () {
        ...
        if ($.fn.dataTable.isDataTable('#itemCategoryTable')) {
        $('#itemCategoryTable').DataTable().destroy();
    }

        itemCategoryTable = $('#itemCategoryTable').DataTable({
            ...
            {name: "description", data: "description"},
            {
                ...
                defaultContent: `
                    <div class="d-flex justify-content-center list-user-action">
                       ...
                       <a class="btn btn-sm btn-icon btn-warning edit-item-category" data-bs-toggle="tooltip" data-bs-placement="top" data-original-title="Edit" href="#" aria-label="Edit" data-bs-original-title="Edit">
                          <span class="btn-inner">
    ...
    $('#itemCategoryTable thead th:eq(0)').html('<input type="checkbox" id="select-all">');

    // Initially hide the delete button
    $('#delete-item-category').hide();


    /* Handle the select/deselect all functionality */
    $('#select-all').on('click', function() {
        var rows = itemCategoryTable.rows({ 'search': 'applied' }).nodes();
    ...
    $('#itemCategoryTable tbody').on('change', 'input[type="checkbox"]', function() {
        if (!this.checked) {
    ...
    $('#delete-item-category').on('click', function() {
    console.log('Delete button clicked');  // Add this line

    // Get the IDs of the selected user groups
    var selectedIds = $('#itemCategoryTable input[type="checkbox"]:checked').map(function() {
            ...
            if (result.isConfirmed) {
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        itemCategoryTable.ajax.reload(function() {
                            // Show or hide buttons based on whether any checkboxes are selected
                            toggleButtons();
                        }, false);
                ...
                $('#itemCategoryTable input[type="checkbox"]').prop('checked', false);
                // Show or hide buttons based on whether any checkboxes are selected
                toggleButtons();
            }
        });
