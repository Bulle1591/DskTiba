  ...
  $(document).ready(function () {
      const element = document.getElementById('itemCategoryModal');
      const form = element.querySelector('#itemCategoryForm');
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#itemCategoryForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#itemCategoryForm')[0]),   // our data object
                          ...
                          if (data.success) {
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#itemCategoryForm'); // Replace with your form's ID
   ...
   // Cancel button handler
      ...
      closeButton.addEventListener('click', e => {
          ...
          Swal.fire({
              text: "Are you sure you would like to close modal?",
              icon: "warning",
              showCancelButton: true,
              buttonsStyling: false,
              ...
              if (result.value) {
                  ...
                  Swal.fire({
                      text: "Your modal has not been closed!.",
                      icon: "error",
                      buttonsStyling: false,
                      confirmButtonText: "Ok, got it!",
                      customClass: {
