  ...
  $(document).ready(function () {
      const element = document.getElementById('equipmentSubcategoryModal');
      const form = element.querySelector('#equipmentSubcategoryForm');
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#equipmentSubcategoryForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#equipmentSubcategoryForm')[0]),   // our data object
                      ...
                      success: function(data) {
                          ...
                          if (data.success) {
                              ...
                              // Refresh the table
                              equipmentSubcategoryTable.ajax.reload()
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#equipmentSubcategoryForm'); // Replace with your form's ID
                                      ...
                                      $('#equipmentSubcategoryModal').modal('hide');
