  ...
  $(document).ready(function () {
      const element = document.getElementById('supplierModal');
      const form = element.querySelector('#supplierForm');
      ...
      form,
          {
              fields: {
                  ...
                  contact_person: {
                      validators: {
                          notEmpty: {
                              message: "Contact personal can not be empty!"
                          }
                      }
                  },
                  email: {
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#supplierForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#supplierForm')[0]),   // our data object
                          ...
                          if (data.success) {
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#supplierForm'); // Replace with your form's ID
