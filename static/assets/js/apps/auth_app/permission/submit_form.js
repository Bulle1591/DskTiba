  ...
  $(document).ready(function () {
      const element = document.getElementById('userPermissionModal');
      const form = element.querySelector('#userPermissionForm');
      ...
      form,
          {
              fields: {
                  ...
                  description: {
                      validators: {
                          notEmpty: {
                              message: "Please provide permission details"
                          }
                      }
                  }
              },
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#userPermissionForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#userPermissionForm')[0]),   // our data object
                      ...
                      success: function(data) {
                          ...
                          if (data.success) {
                              ...
                              // Refresh the table
                              userPermissionTable.ajax.reload();
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#userPermissionForm'); // Replace with your form's ID
...
$('#userPermissionModal').on('hidden.bs.modal', function (e) {
