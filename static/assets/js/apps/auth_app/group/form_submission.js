  ...
  $(document).ready(function () {
      const element = document.getElementById('userGroupModal');
      const form = element.querySelector('#userGroupForm');
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#userGroupForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#userGroupForm')[0]),   // our data object
                          ...
                          if (data.success) {
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#userGroupForm'); // Replace with your form's ID
