...
var roleTable;
            ...
            {name: "description", data: "description"},
            {
                ...
                defaultContent: `
                    <div class="d-flex justify-content-center">
                        <button class="btn btn-info btn-icon btn-sm rounded-pill" role="button">
                        ...
                        <button class="btn btn-light btn-icon btn-sm rounded-pill ms-2 edit-user-group" role="button">
                            <span class="btn-inner">
    ...
    $('#roleTable thead th:eq(0)').html('<input type="checkbox" id="select-all">');
    ...
    var selectedIds = $('#roleTable input[type="checkbox"]:checked').map(function() {
...
function toggleButtons() {
    if ($('#roleTable input[type="checkbox"]:checked').length > 0) {
