  ...
  $(document).ready(function () {
      ...
      const form = element.querySelector('#RoleForm');
      ...
      form,
          {
              fields: {
                  ...
                  description: {
                      validators: {
                          notEmpty: {
                              message: "Role description can not be empty!"
                          }
                      }
                  }
              },
      ...
      $(form).on('submit', function(e) {
          ...
          validator.validate().then(function(status) {
              if (status === 'Valid') {
                  ...
                  $.ajax({
                    url: $('#RoleForm').attr('action'),  // the url where we want to POST
                      headers: { "X-CSRFToken": getCookie("csrftoken") },
                      type: 'POST',  // define the type of HTTP verb we want to use (POST for our form)
                      data: new FormData($('#RoleForm')[0]),   // our data object
                          ...
                          if (data.success) {
                              ...
                              Swal.fire({
                                  ...
                                  if (result.isConfirmed) {
                                      const formElement = document.querySelector('#RoleForm'); // Replace with your form's ID
